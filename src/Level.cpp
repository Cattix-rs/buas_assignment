...
namespace Tmpl8
{
	...
	const Collider colliders_1[] =
	{
		...
		Collider{{463.0f, 0.0f},{467.0f,139.0f},ColliderType::Solid,phase_switch_lvl::lvl_1Set2},
		...
		Collider{{576.0f, 391.0f},{627, 448},ColliderType::Solid,phase_switch_lvl::lvl_1Set2},
